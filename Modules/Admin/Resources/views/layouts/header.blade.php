      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.category.get')}}"><i class="fa fa-circle-o"></i> Chuyên mục</a></li>
            <li><a href="{{route('admin.post.get')}}"><i class="fa fa-circle-o"></i> Tất cả bài viết</a></li>
