				...
				<div class="p-b-20">
					...
					<div class="tab01 p-b-20">
						<div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991">
							...
							<!--  -->
							<a href="{{route('get.category.index',[$category->c_slug,$category->id])}}" class="tab01-link f1-s-1 cl9 hov-cl10 trans-03">
								Xem tất cả
							...
							<div class="tab-pane fade show active" role="tabpanel">
								<div class="row">
									<div class="col-sm-6 p-r-25 p-r-15-sr991">
										@foreach($category->getListPostHome as $post)
										@if ($loop->first)
										<!-- Item post -->
										<div class="m-b-30">
											<a href="{{route('get.post.index',[$post->p_slug, $post->id])}}" class="wrap-pic-w hov1 trans-03">
												<img src="{{pare_url_file($post->p_avatar)}}" alt="IMG">
											</a>

											<div class="p-t-20">
												<h5 class="p-b-5">
													<a href="{{route('get.post.index',[$post->p_slug, $post->id])}}" class="f1-m-3 cl2 hov-cl10 trans-03">
														{{$post->p_name}}
													</a>
												</h5>

												<span class="cl8">
													<a href="{{route('get.category.index',[$post->category->c_slug,$post->category->id])}}" class="f1-s-4 cl8 hov-cl10 trans-03">
									...
									<div class="col-sm-6 p-r-25 p-r-15-sr991">
										...
										<div class="flex-wr-sb-s m-b-30">
											<a href="{{route('get.post.index',[$post->p_slug, $post->id])}}" class="size-w-1 wrap-pic-w hov1 trans-03">
												<img src="{{pare_url_file($post->p_avatar)}}" alt="IMG">
											</a>

											<div class="size-w-2">
												<h5 class="p-b-5">
													<a href="{{route('get.post.index',[$post->p_slug, $post->id])}}" class="f1-s-5 cl3 hov-cl10 trans-03">
														{{$post->p_name}}
													</a>
												</h5>

												<span class="cl8">
													<a href="{{route('get.category.index',[$post->category->c_slug,$post->category->id])}}" class="f1-s-6 cl8 hov-cl10 trans-03">
														{{$post->category->c_name}}
													</a>
