		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-header-mobile">
				...
				<div class="logo-mobile">
					<a href="{{route('home.index')}}"><img src="{{asset('assets')}}/images/icons/logo-01.png" alt="IMG-LOGO"></a>
				</div>
			...
			<div class="wrap-logo container">
				<!-- Logo desktop -->
				<div class="logo">
					<a href="{{route('home.index')}}"><img src="{{asset('assets')}}/images/icons/logo-01.png" alt="LOGO"></a>
				</div>
			...
			<div class="wrap-main-nav">
				<div class="main-nav">
					...
					<nav class="menu-desktop">
						<a class="logo-stick" href="{{route('home.index')}}">
						...
						<ul class="main-menu">
							...
							<li class="mega-menu-item">
								<a href="{{route('get.category.index',[$category->c_slug,$category->id])}}"> {{$category->c_name}}</a>
